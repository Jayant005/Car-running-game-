...
blue=(0,0,255)
gray=(119,118,110)
car_img=pygame.image.load("car-clipart-sprite-sheet-14.png")
car_img=pygame.transform.scale(car_img,(100,100))
background=pygame.image.load("background1.jpg")
grass=pygame.image.load("downloade12.jpg")
...
def car_crash(x,x_r,y,y_r):
    if x_r<x<x_r+70 and y_r<y<y_r+70 or x_r<x+70<x_r+70 and y_r<y<y_r+70:
